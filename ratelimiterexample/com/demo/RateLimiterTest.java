...
public class RateLimiterTest implements RateLimitListener{
	...
	// Inspect the TPS value in the prints and play around with this value. 
	//Increase this value to avoid throttling
	...
	private void test() throws InterruptedException{
		...
		{
			RateLimitManager._instance.pegTraffic(instance_id);Thread.sleep(sleepTime);
		}
		try 
		{

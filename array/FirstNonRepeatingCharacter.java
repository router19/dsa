...
public class FirstNonRepeatingCharacter {
    ...
    { 
        ...
        //inDLL will have list of all non - repeating characters.
        // get(k-1) will give the kth non-repeating character
        if(inDLL.size() != 0)
        {
        	System.out.println("First non repeating is " + inDLL.get(0));
        	System.out.println("k = 3 rd non repeating is   " + inDLL.get(3-1));
        }
    } 
